...
- [x] **CLI Subcommands**: `./workplace/workplace/bin/percipience cicd {run, heal, sustain, optimize}`.
...
- **Autonomous Issue Ingestion**: Bidirectional integration with Jira, GitHub Issues, and Linear via MCP connectors (`workplace/bin/percipience mcp jira pull`).
