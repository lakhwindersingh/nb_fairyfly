...
> **Last Updated**: 2026-09-17T16:28:17.950724+00:00  
...
| :--- | :--- | :--- |
| **Total AST Pruning Events** | **3,161** | Discrete files/turns optimized across CI/CD runs |
| **Uncompressed Context Tokens** | **6,043,287** tokens | Baseline tokens if passed unmanaged to Claude/OpenAI |
| **Pruned Context Tokens** | **3,091,023** tokens | Structural interface skeletons actually sent |
| **Total Tokens Saved** | **2,952,264** tokens | Net volume eliminated from context windows |
| **Average Token Reduction Ratio**| **48.9%** | Consistent with 50%–70% target reduction |
| **Gross Financial Savings** | **$8.8568** | Direct inference API bill reduction |
| **15% Percipience Performance Fee**| **$1.3286** | Aligned value capture model |
| **Net Customer Cash Savings** | **$7.5282** | **Positive Net Return** post performance fee |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| `tok_evt_20260917_1` | 2026-09-17T16:28:16 | `workplace/src/lib/seo.ts` | 482 | 112 | 370 | **76.8%** | `$0.00094` |
| `tok_evt_20260917_1` | 2026-09-17T16:28:14 | `workplace/src/lib/sitemap_generator.ts` | 495 | 346 | 149 | **30.1%** | `$0.00038` |
| `tok_evt_20260917_1` | 2026-09-17T16:28:12 | `workplace/src/lib/i18n.ts` | 1490 | 1478 | 12 | **0.8%** | `$0.00003` |
| `tok_evt_20260917_1` | 2026-09-17T16:28:09 | `workplace/modules/mod_observability_usage/quarantine_console.ts` | 179 | 99 | 80 | **44.7%** | `$0.00020` |
| `tok_evt_20260917_1` | 2026-09-17T16:28:07 | `workplace/modules/mod_observability_usage/lease_monitor.ts` | 186 | 80 | 106 | **57.0%** | `$0.00027` |
| `tok_evt_20260917_1` | 2026-09-17T16:28:05 | `workplace/modules/mod_observability_usage/merkle_explorer.ts` | 337 | 92 | 245 | **72.7%** | `$0.00063` |
| `tok_evt_20260917_1` | 2026-09-17T16:28:03 | `workplace/modules/mod_observability_usage/telemetry_stream.ts` | 159 | 65 | 94 | **59.1%** | `$0.00024` |
| `tok_evt_20260917_1` | 2026-09-17T16:28:01 | `workplace/modules/mod_tenant_onboarding/auth.ts` | 194 | 96 | 98 | **50.5%** | `$0.00025` |
| `tok_evt_20260917_1` | 2026-09-17T16:27:58 | `workplace/modules/mod_tenant_onboarding/byor_wizard.ts` | 212 | 142 | 70 | **33.0%** | `$0.00018` |
| `tok_evt_20260917_1` | 2026-09-17T16:27:56 | `workplace/modules/mod_tenant_onboarding/provisioner.ts` | 156 | 54 | 102 | **65.4%** | `$0.00026` |
