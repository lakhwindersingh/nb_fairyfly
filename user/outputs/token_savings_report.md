...
> **Last Updated**: 2026-09-16T02:48:50.774770+00:00  
...
| :--- | :--- | :--- |
| **Total AST Pruning Events** | **759** | Discrete files/turns optimized across CI/CD runs |
| **Uncompressed Context Tokens** | **1,076,809** tokens | Baseline tokens if passed unmanaged to Claude/OpenAI |
| **Pruned Context Tokens** | **600,522** tokens | Structural interface skeletons actually sent |
| **Total Tokens Saved** | **476,287** tokens | Net volume eliminated from context windows |
| **Average Token Reduction Ratio**| **44.2%** | Consistent with 50%–70% target reduction |
| **Gross Financial Savings** | **$1.4289** | Direct inference API bill reduction |
| **15% Percipience Performance Fee**| **$0.2143** | Aligned value capture model |
| **Net Customer Cash Savings** | **$1.2145** | **Positive Net Return** post performance fee |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| `tok_evt_20260916_0` | 2026-09-16T02:48:50 | `workplace/modules/mod_observability_usage/quarantine_console.ts` | 179 | 99 | 80 | **44.7%** | `$0.00020` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:49 | `workplace/modules/mod_observability_usage/lease_monitor.ts` | 186 | 80 | 106 | **57.0%** | `$0.00027` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:49 | `workplace/modules/mod_observability_usage/merkle_explorer.ts` | 337 | 92 | 245 | **72.7%** | `$0.00063` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:48 | `workplace/modules/mod_observability_usage/telemetry_stream.ts` | 159 | 65 | 94 | **59.1%** | `$0.00024` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:48 | `workplace/modules/mod_tenant_onboarding/auth.ts` | 194 | 96 | 98 | **50.5%** | `$0.00025` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:47 | `workplace/modules/mod_tenant_onboarding/byor_wizard.ts` | 212 | 142 | 70 | **33.0%** | `$0.00018` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:47 | `workplace/modules/mod_tenant_onboarding/provisioner.ts` | 156 | 54 | 102 | **65.4%** | `$0.00026` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:46 | `workplace/modules/mod_portal_marketing/components/roi_calculator.ts` | 241 | 112 | 129 | **53.5%** | `$0.00033` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:45 | `workplace/modules/mod_portal_marketing/components/ast_pruner_demo.ts` | 289 | 52 | 237 | **82.0%** | `$0.00060` |
| `tok_evt_20260916_0` | 2026-09-16T02:48:45 | `workplace/modules/mod_portal_marketing/components/infrastructure_economics.ts` | 976 | 792 | 184 | **18.9%** | `$0.00047` |
