...
./bin/percipience layer apply --plan .nb/plan/templates/custom_{{DOMAIN_SLUG}}_domain_plan.md

# 3. Scaffold and integrate domain subagents
./bin/percipience agent create --name {{SPECIALIST_AGENT_1}} --template cicd_quality --role "{{DOMAIN_NAME}} Specialist"
./bin/percipience agent integrate --agent agent_{{SPECIALIST_AGENT_1}} --workflow wf_pr_gatekeeper --after step_contract_compat
